...
const Invitation = props => (
  <Layout>
    ...
    <div id="main" className="alt invitation-page">
      <section id="one">
        <div className="inner">
          <header className="major page-header">
            <h1>オーガナイザーチームから</h1>
          </header>

          <div className="hero-section">
            <span className="image main hero-image">
              <img src={pic15} alt="沖縄の道" />
            </span>
            <div className="intro-text">
              <p>
                私たちは、NVCを共に学び、共に探求してきた仲間たちでもあり、<br />
          ...
          <div className="organizers-grid">
            ...
            <section>
              ...
              <p>
                ...
                <br />
                2021年に予定されていたヨラムの初来日ワークショップは、コロナ禍によりオンラインへと変更を余儀なくされました。以降「いつの日か、機会がくることを・・・」と想いから、また、「日本人が日本語でじゅうぶんに学べる環境をつくりたい」という強い願いに導かれてこの企画が実現しようとしていることに、特別な想いを感じています。NVCの学びや実践において本当に豊かだなと思うのは、その多様性です。新たな視点や体験の中であうことが、きっと私たちのやわらかな感受性や気づきの芽をひらかせてくれることと思います。2026年4月、春の日に会場でお目にかかれますことを、楽しみにしています。
              </p>
            </section>
          ...
          <section className="interpreter-section">
            ...
            <div className="interpreter-grid">
              <div className="interpreter-card">
                <h4 className="location">東京</h4>
                <p className="names">スキップ・後藤ゆう子</p>
              </div>

              <div className="interpreter-card">
                <h4 className="location">沖縄</h4>
                <p className="names">仲間聡子・後藤ゆう子</p>
              </div>
            </div>
          </section>
